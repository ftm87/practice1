...
public class Runner {
    ...
    public static void main(String[] args) {
      ...
      Map<String,Double>sonuc = employees.
              stream().
              collect(Collectors.groupingBy(Employee::getDepartment,//gruplandirma yapildi
                Collectors.averagingDouble(Employee::getSalary)));//ort maas deegri
